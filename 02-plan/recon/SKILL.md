...
- **[blast-radius](../../01-decide/blast-radius/SKILL.md)** — prices a one-way door the map exposes.
- **[debug-mantra](../../04-build/debug-mantra/SKILL.md)** — traces a fail path for a bug happening now; recon traces edges for a change that has not happened yet.
